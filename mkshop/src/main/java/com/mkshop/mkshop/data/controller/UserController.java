...
import com.mkshop.mkshop.domain.DTO.UserRegisterDTO;
...
//                        result.setPassword(user.getPassword().isEmpty() ?
//                                result.getPassword() : passwordEncoder.encode(user.getPassword())
//                        );
//
